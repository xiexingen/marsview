 ...
 *-----------------------------------------------------------*/ define('vs/editor/editor.main.nls', {
  ...
  'vs/base/browser/ui/inputbox/inputBox': ['Error: {0}', 'Warning: {0}', 'Info: {0}', ' or {0} for history', ' ({0} for history)', 'Cleared Input'],
 ...
 - Values greater than or equal to 8 will be used as effective values.`,
  ...
  'vs/editor/contrib/codeAction/browser/codeActionController': ['Context: {0} at line {1} and column {2}.', 'Hide Disabled', 'Show Disabled'],
  ...
  'vs/editor/contrib/codelens/browser/codelensController': ['Show CodeLens Commands For Current Line', 'Select a command'],
  'vs/editor/contrib/colorPicker/browser/colorPickerWidget': ['Click to toggle color options (rgb/hsl/hex)', 'Icon to close the color picker'],
...
{1}`,
  ...
  'vs/editor/contrib/fontZoom/browser/fontZoom': ['Increase Editor Font Size', 'Decrease Editor Font Size', 'Reset Editor Font Size'],
  ...
  'vs/editor/contrib/hover/browser/hoverActionIds': ['Increase Hover Verbosity Level', 'Decrease Hover Verbosity Level'],
  ...
  'vs/editor/contrib/inlineCompletions/browser/inlineCompletionsController': ['Inspect this in the accessible view ({0})'],
  ...
  'vs/editor/contrib/readOnlyMessage/browser/contribution': ['Cannot edit in read-only input', 'Cannot edit in read-only editor'],
  ...
  'vs/platform/action/common/actionCommonCategories': ['View', 'Help', 'Test', 'File', 'Preferences', 'Developer'],
  'vs/platform/actionWidget/browser/actionList': ['{0} to Apply, {1} to Preview', '{0} to Apply', '{0}, Disabled Reason: {1}', 'Action Widget'],
