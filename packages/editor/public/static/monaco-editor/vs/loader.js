    ...
    static getHighPerformanceTimestamp() {
      return (
        this.PERFORMANCE_NOW_PROBED ||
          ((this.PERFORMANCE_NOW_PROBED = !0), (this.HAS_PERFORMANCE_NOW = u.global.performance && typeof u.global.performance.now == 'function')),
...
(function (u) {
  ...
  class p {
    ...
    moduleIdToPaths(r) {
      if (this._env.isNode && this.options.amdModulesPattern instanceof RegExp && !this.options.amdModulesPattern.test(r))
    ...
    requireToUrl(r) {
      let c = r;
      return (
        u.Utilities.isAbsolutePath(c) || ((c = this._applyPaths(c)[0]), u.Utilities.isAbsolutePath(c) || (c = this.options.baseUrl + c)),
...
//# sourceURL=${i}`),
  ...
  class r {
    ...
    _init(e) {
      this._didInitialize ||
        ((this._didInitialize = !0), (this._fs = e('fs')), (this._vm = e('vm')), (this._path = e('path')), (this._crypto = e('crypto')));
    }
...
(function (u) {
    ...
    resolveModule(t) {
      ...
      return (
        u.Utilities.isAbsolutePath(e) ||
          ((u.Utilities.startsWith(e, './') || u.Utilities.startsWith(e, '../')) && (e = y._normalizeModuleId(this.fromModulePath + e))),
        e
      );
    }
  }
      ...
      if (this._callback)
        if (typeof this._callback == 'function') {
          ...
          (n = l.producedError),
            ...
            !n && typeof l.returnedValue < 'u' && (!this.exportsPassedIn || u.Utilities.isEmpty(this.exports)) && (this.exports = l.returnedValue);
  ...
  class c {
    ...
    defineModule(t, e, i, s, n, l = new y(t)) {
      ...
      (this._modules2[d] = o),
        this._config.isBuild() &&
          ...
          (this._buildInfoDependencies[d] = (o.dependencies || []).map((_) => this._moduleIdProvider.getStrModuleId(_.id)))),
        this._resolve(o);
    }
    ...
    synchronousRequire(t, e = new y(t)) {
      ...
      if (!s)
        throw new Error("Check dependency list! Synchronous require cannot resolve module '" + t + "'. This is the first mention of this module!");
      if (!s.isComplete())
        throw new Error(
          "Check dependency list! Synchronous require cannot resolve module '" + t + "'. This module has not been resolved completely yet.",
        );
...
`),
          ...
          if (
            ((this._inverseDependencies2[n.id] = this._inverseDependencies2[n.id] || []), this._inverseDependencies2[n.id].push(t.id), n instanceof r)
          ) {
